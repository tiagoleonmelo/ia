...
class MySN(SemanticNetwork):
    ...
    def query_dependents(self,entity):
        ...
        dependants = [d.relation.entity1 for d in self.declarations if isinstance(d.relation, Depends) and d.relation.entity2 == entity]

        # querying local children for dependencies
        local = [self.query_dependents(d.relation.entity1) for d in self.declarations if isinstance(d.relation, Subtype) and d.relation.entity2 == entity]
        
        l = [item for sublist in local for item in sublist]
        ...
        for p in dependants:
            ...
            children = [d.relation.entity1 for d in self.declarations if d.relation.entity2 == p and isinstance(d.relation, Subtype)]
