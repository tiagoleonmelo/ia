...
# ## Testing the blanket for every key
# for key in bn.dependencies.keys():
#     print("Markov blanket of \'%s\'" % key)
#     print(bn.markov_blanket(key))
#     print("-------------------------------------------")


# print("dependents of 'spark plug':", z.query_dependents('energy'))
# print('\n\n\n\n\n')
# l = ['dashboard', 'diesel engine', 'petrol', 'gearbox', 'energy', 'engine', 'battery', 'illumination']
# for coisa in l:
#     print("-------------------------------------------")
#     print("dependes of '{}': {}".format(coisa, z.query_dependents(coisa)))
# print("-------------------------------------------")

# for coisa in l:
#     print("-------------------------------------------")
#     print("causes of '{}': {}".format(coisa, z.query_causes(coisa)))
# print("-------------------------------------------")

# for coisa in l:
#     print("-------------------------------------------")
#     print("sorted causes of '{}': {}".format(coisa,z.query_causes_sorted(coisa)))
# print("-------------------------------------------")

# l=['a','b_a','c_s','d','m_f','b_v','s_m','s_p','v_p','h','s_s','s_t','s_q','f_s','c_c','car_s']
# for coisa in l:
#     print("-------------------------------------------")
#     print("markov blanket of '{}': {}".format(coisa,bn.markov_blanket(coisa)))
# print("-------------------------------------------")
