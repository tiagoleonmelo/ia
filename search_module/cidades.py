...
class Cidades(SearchDomain):
    ...
    def cost(self, state, action):
        (c1, c2) = action
        if c1 == state:
            for (origin, destination, cost) in self.connections:
                if (origin == c1 and destination == c2) or (origin == c2 and destination == c1):
                    return cost
...
print(t.search())
# print(cidades_portugal.cost('Coimbra', ('Coimbra', 'Leiria')))
# print(cidades_portugal.heuristic('Coimbra', 'Leiria'))
